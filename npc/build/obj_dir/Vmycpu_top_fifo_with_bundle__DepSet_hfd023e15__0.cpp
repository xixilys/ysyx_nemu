...
VL_INLINE_OPT void Vmycpu_top_fifo_with_bundle___nba_comb__TOP__mycpu_top__u_riscv_cpu__fifo_with_bundle__62(Vmycpu_top_fifo_with_bundle* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_fifo_with_bundle___nba_comb__TOP__mycpu_top__u_riscv_cpu__fifo_with_bundle__62\n"); );
    // Body
    vlSelf->__PVT___read_length_points_T_7 = (0xfU 
                                              & ((IData)(vlSelf->__PVT__read_length_points) 
                                                 + (IData)(vlSelf->__PVT___GEN_59)));
...
VL_INLINE_OPT void Vmycpu_top_fifo_with_bundle___nba_comb__TOP__mycpu_top__u_riscv_cpu__fifo_with_bundle__63(Vmycpu_top_fifo_with_bundle* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_fifo_with_bundle___nba_comb__TOP__mycpu_top__u_riscv_cpu__fifo_with_bundle__63\n"); );
    // Body
...
VL_INLINE_OPT void Vmycpu_top_fifo_with_bundle___nba_comb__TOP__mycpu_top__u_riscv_cpu__fifo_with_bundle__64(Vmycpu_top_fifo_with_bundle* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_fifo_with_bundle___nba_comb__TOP__mycpu_top__u_riscv_cpu__fifo_with_bundle__64\n"); );
    // Body
