...
VL_ATTR_COLD void Vmycpu_top_BTB_banks_oneissue_with_block_ram___eval_initial__TOP__mycpu_top__u_riscv_cpu__branch_prediction_with_blockram__BTB_banks_oneissue_with_block_ram(Vmycpu_top_BTB_banks_oneissue_with_block_ram* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vmycpu_top_BTB_banks_oneissue_with_block_ram___eval_initial__TOP__mycpu_top__u_riscv_cpu__branch_prediction_with_blockram__BTB_banks_oneissue_with_block_ram\n"); );
}
