...
VL_INLINE_OPT void Vmycpu_top_fifo_with_bundle___nba_comb__TOP__mycpu_top__u_riscv_cpu__fifo_with_bundle__65(Vmycpu_top_fifo_with_bundle* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_fifo_with_bundle___nba_comb__TOP__mycpu_top__u_riscv_cpu__fifo_with_bundle__65\n"); );
    // Body
...
VL_INLINE_OPT void Vmycpu_top_fifo_with_bundle___nba_comb__TOP__mycpu_top__u_riscv_cpu__fifo_with_bundle__66(Vmycpu_top_fifo_with_bundle* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_fifo_with_bundle___nba_comb__TOP__mycpu_top__u_riscv_cpu__fifo_with_bundle__66\n"); );
    // Body
