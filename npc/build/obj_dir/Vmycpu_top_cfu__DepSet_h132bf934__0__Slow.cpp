...
VL_ATTR_COLD void Vmycpu_top_cfu___settle__TOP__mycpu_top__u_riscv_cpu___cfu__54(Vmycpu_top_cfu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_cfu___settle__TOP__mycpu_top__u_riscv_cpu___cfu__54\n"); );
    // Body
...
VL_ATTR_COLD void Vmycpu_top_cfu___settle__TOP__mycpu_top__u_riscv_cpu___cfu__55(Vmycpu_top_cfu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_cfu___settle__TOP__mycpu_top__u_riscv_cpu___cfu__55\n"); );
    // Body
...
VL_ATTR_COLD void Vmycpu_top_cfu___settle__TOP__mycpu_top__u_riscv_cpu___cfu__56(Vmycpu_top_cfu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_cfu___settle__TOP__mycpu_top__u_riscv_cpu___cfu__56\n"); );
    // Body
    vlSelf->__PVT__io_StallW = ((IData)(vlSelf->__PVT__reset) 
                                | (IData)(vlSelf->__PVT___io_StallM_T_1));
}

VL_ATTR_COLD void Vmycpu_top_cfu___settle__TOP__mycpu_top__u_riscv_cpu___cfu__57(Vmycpu_top_cfu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_cfu___settle__TOP__mycpu_top__u_riscv_cpu___cfu__57\n"); );
    // Body
    vlSelf->__PVT__io_StallD = (1U & ((IData)(vlSelf->__PVT__reset) 
                                      | (~ (IData)(vlSelf->__PVT___io_StallF_T_5))));
}

VL_ATTR_COLD void Vmycpu_top_cfu___settle__TOP__mycpu_top__u_riscv_cpu___cfu__58(Vmycpu_top_cfu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_cfu___settle__TOP__mycpu_top__u_riscv_cpu___cfu__58\n"); );
    // Body
...
VL_ATTR_COLD void Vmycpu_top_cfu___settle__TOP__mycpu_top__u_riscv_cpu___cfu__59(Vmycpu_top_cfu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_cfu___settle__TOP__mycpu_top__u_riscv_cpu___cfu__59\n"); );
    // Body
