...
VL_INLINE_OPT void Vmycpu_top_cfu___nba_sequent__TOP__mycpu_top__u_riscv_cpu___cfu__0(Vmycpu_top_cfu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_cfu___nba_sequent__TOP__mycpu_top__u_riscv_cpu___cfu__0\n"); );
    // Body
    vlSelf->__PVT__io_StallM = (1U & ((IData)(vlSelf->__PVT__reset) 
                                      | (~ (IData)(vlSelf->__PVT__io_DataPendingM))));
    vlSelf->__PVT___io_StallM_T_1 = (1U & (~ (IData)(vlSelf->__PVT__io_DataPendingM)));
...
VL_INLINE_OPT void Vmycpu_top_cfu___nba_comb__TOP__mycpu_top__u_riscv_cpu___cfu__47(Vmycpu_top_cfu* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_cfu___nba_comb__TOP__mycpu_top__u_riscv_cpu___cfu__47\n"); );
    // Body
    vlSelf->__PVT__io_FlushW = ((~ (IData)(vlSelf->__PVT__reset)) 
                                & ((IData)(vlSelf->__PVT__io_StallW) 
                                   & ((IData)(vlSelf->__PVT__io_DataPendingM) 
