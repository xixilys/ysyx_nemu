...
VL_ATTR_COLD void Vmycpu_top_data_cache___stl_sequent__TOP__mycpu_top__data_cache__0(Vmycpu_top_data_cache* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vmycpu_top_data_cache___stl_sequent__TOP__mycpu_top__data_cache__0\n"); );
    // Body
...
VL_ATTR_COLD void Vmycpu_top_data_cache___stl_sequent__TOP__mycpu_top__data_cache__1(Vmycpu_top_data_cache* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vmycpu_top_data_cache___stl_sequent__TOP__mycpu_top__data_cache__1\n"); );
    // Body
...
VL_ATTR_COLD void Vmycpu_top_data_cache___stl_sequent__TOP__mycpu_top__data_cache__2(Vmycpu_top_data_cache* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vmycpu_top_data_cache___stl_sequent__TOP__mycpu_top__data_cache__2\n"); );
    // Body
...
VL_ATTR_COLD void Vmycpu_top_data_cache___stl_sequent__TOP__mycpu_top__data_cache__3(Vmycpu_top_data_cache* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vmycpu_top_data_cache___stl_sequent__TOP__mycpu_top__data_cache__3\n"); );
    // Body
