...
VL_ATTR_COLD void Vmycpu_top_if2id___eval_initial__TOP__mycpu_top__u_riscv_cpu___if2id(Vmycpu_top_if2id* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_if2id___eval_initial__TOP__mycpu_top__u_riscv_cpu___if2id\n"); );
}

VL_ATTR_COLD void Vmycpu_top_if2id___stl_sequent__TOP__mycpu_top__u_riscv_cpu___if2id__0(Vmycpu_top_if2id* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_if2id___stl_sequent__TOP__mycpu_top__u_riscv_cpu___if2id__0\n"); );
    // Body
...
VL_ATTR_COLD void Vmycpu_top_if2id___stl_sequent__TOP__mycpu_top__u_riscv_cpu___if2id__1(Vmycpu_top_if2id* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_if2id___stl_sequent__TOP__mycpu_top__u_riscv_cpu___if2id__1\n"); );
    // Body
