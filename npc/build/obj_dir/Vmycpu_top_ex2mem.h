...
class Vmycpu_top_ex2mem final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        VL_IN64(__PVT__io_mem_trace_budleE_data,63,0);
        VL_IN64(__PVT__io_mem_trace_budleE_addr,63,0);
        VL_IN8(__PVT__io_mem_trace_budleE_cache,0,0);
        VL_OUT8(__PVT__io_mem_trace_budleM_cache,0,0);
        ...
        VL_OUT64(__PVT__io_mem_trace_budleM_data,63,0);
