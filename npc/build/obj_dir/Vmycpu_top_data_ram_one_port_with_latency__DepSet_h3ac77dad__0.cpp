...
VL_INLINE_OPT void Vmycpu_top_data_ram_one_port_with_latency___nba_sequent__TOP__mycpu_top__inst_cache__icache_data_1__icache_data_ram_0__4(Vmycpu_top_data_ram_one_port_with_latency* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vmycpu_top_data_ram_one_port_with_latency___nba_sequent__TOP__mycpu_top__inst_cache__icache_data_1__icache_data_ram_0__4\n"); );
    // Body
...
VL_INLINE_OPT void Vmycpu_top_data_ram_one_port_with_latency___nba_sequent__TOP__mycpu_top__inst_cache__icache_data_1__icache_data_ram_0__7(Vmycpu_top_data_ram_one_port_with_latency* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vmycpu_top_data_ram_one_port_with_latency___nba_sequent__TOP__mycpu_top__inst_cache__icache_data_1__icache_data_ram_0__7\n"); );
    // Body
    vlSelf->__PVT__Look_up_table_read_first___05Fio_ar_addr 
        = vlSelf->__PVT__io_addra;
    vlSelf->__PVT__Look_up_table_read_first___05F1_io_ar_addr 
