...
class Vmycpu_top_cu final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*6:0*/ __PVT___inst_code_type_T_156;
        CData/*6:0*/ __PVT___inst_code_type_T_158;
        CData/*7:0*/ __PVT___inst_code_type_T_181;
        ...
        SData/*9:0*/ __PVT___inst_code_type_T_159;
        SData/*9:0*/ __PVT___inst_code_type_T_167;
        SData/*9:0*/ __PVT___inst_code_type_T_169;
        SData/*9:0*/ __PVT___inst_code_type_T_171;
        SData/*9:0*/ __PVT___inst_code_type_T_173;
        SData/*9:0*/ __PVT___inst_code_type_T_175;
        SData/*9:0*/ __PVT___inst_code_type_T_177;
        SData/*9:0*/ __PVT___inst_code_type_T_179;
        SData/*9:0*/ __PVT___inst_code_type_T_183;
        SData/*9:0*/ __PVT___inst_code_type_T_185;
        SData/*9:0*/ __PVT___inst_code_type_T_187;
        SData/*9:0*/ __PVT___inst_code_type_T_189;
        SData/*9:0*/ __PVT___inst_code_type_T_191;
        SData/*9:0*/ __PVT___inst_code_type_T_193;
        SData/*9:0*/ __PVT___inst_code_type_T_195;
        SData/*9:0*/ __PVT___inst_code_type_T_197;
        SData/*9:0*/ __PVT___inst_code_type_T_199;
        SData/*9:0*/ __PVT___inst_code_type_T_201;
        SData/*9:0*/ __PVT___inst_code_type_T_203;
        VL_OUT8(__PVT__io1_BadInstrD,0,0);
        VL_OUT8(__PVT__io1_SysCallD,0,0);
        VL_OUT8(__PVT__io1_EretD,0,0);
        VL_OUT8(__PVT__io_data_wD,0,0);
        VL_OUT8(__PVT__io_MemWriteD,0,0);
        VL_OUT8(__PVT__io_ALUSrcD_0,1,0);
        VL_OUT8(__PVT__io_LinkD,0,0);
        VL_OUT8(__PVT__io_csrWriteD,0,0);
        VL_OUT8(__PVT__io_LoadUnsignedD,0,0);
        VL_OUT8(__PVT__io_muldiv_cal,0,0);
        VL_OUT8(__PVT__io_csr_Imm,0,0);
    ...
    struct {
        ...
        VL_OUT8(__PVT__io_csrToRegD,0,0);
        ...
        VL_OUT8(__PVT__io_csr_control,5,0);
        CData/*3:0*/ __PVT___io_csr_control_T_7;
        CData/*3:0*/ __PVT___io_csr_control_T_9;
        CData/*3:0*/ __PVT___io_csr_control_T_11;
        CData/*3:0*/ __PVT___io_csr_control_T_13;
        CData/*3:0*/ __PVT___io_csr_control_T_15;
        CData/*3:0*/ __PVT___io_csr_control_T_17;
    ...
    struct {
        ...
        IData/*31:0*/ __PVT___immU_T_1;
        IData/*31:0*/ __PVT___immU_T_34;
