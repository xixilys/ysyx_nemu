...
VL_INLINE_OPT void Vmycpu_top_muldiv___nba_comb__TOP__mycpu_top__u_riscv_cpu___muldiv__10(Vmycpu_top_muldiv* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_muldiv___nba_comb__TOP__mycpu_top__u_riscv_cpu___muldiv__10\n"); );
    // Body
