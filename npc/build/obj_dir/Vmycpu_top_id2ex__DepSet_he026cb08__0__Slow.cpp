...
VL_ATTR_COLD void Vmycpu_top_id2ex___eval_initial__TOP__mycpu_top__u_riscv_cpu___id2ex(Vmycpu_top_id2ex* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_id2ex___eval_initial__TOP__mycpu_top__u_riscv_cpu___id2ex\n"); );
}

VL_ATTR_COLD void Vmycpu_top_id2ex___stl_sequent__TOP__mycpu_top__u_riscv_cpu___id2ex__0(Vmycpu_top_id2ex* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_id2ex___stl_sequent__TOP__mycpu_top__u_riscv_cpu___id2ex__0\n"); );
    // Body
...
VL_ATTR_COLD void Vmycpu_top_id2ex___stl_sequent__TOP__mycpu_top__u_riscv_cpu___id2ex__1(Vmycpu_top_id2ex* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_id2ex___stl_sequent__TOP__mycpu_top__u_riscv_cpu___id2ex__1\n"); );
    // Body
