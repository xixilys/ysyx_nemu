...
class Vmycpu_top_cfu final : public VerilatedModule {
  public:
    ...
    struct {
        VL_IN8(__PVT__io_csrToRegE,0,0);
        VL_OUT8(__PVT__io_ForwardcsrE,1,0);
        CData/*0:0*/ __PVT___io_ForwardcsrE_T_3;
        CData/*0:0*/ __PVT___io_ForwardcsrE_T_6;
        CData/*1:0*/ __PVT___io_ForwardcsrE_T_7;
        CData/*1:0*/ __PVT___io_ForwardcsrE_T_8;
        VL_IN16(__PVT__io_ReadcsrAddrE,11,0);
        VL_IN8(__PVT__io_csrWriteM,0,0);
        VL_IN8(__PVT__io_csrWriteM2,0,0);
        VL_IN16(__PVT__io_WritecsrAddrM,11,0);
        VL_IN16(__PVT__io_WritecsrAddrM2,11,0);
