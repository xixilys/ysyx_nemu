...
VL_ATTR_COLD void Vmycpu_top_regfile___settle__TOP__mycpu_top__u_riscv_cpu___regfile__5(Vmycpu_top_regfile* vlSelf) {
    ...
    // Body
    vlSelf->__PVT___io_RD1_T_3 = (0U != (IData)(vlSelf->__PVT__io_A1));
}
...
VL_ATTR_COLD void Vmycpu_top_regfile___settle__TOP__mycpu_top__u_riscv_cpu___regfile__65(Vmycpu_top_regfile* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_regfile___settle__TOP__mycpu_top__u_riscv_cpu___regfile__65\n"); );
    // Body
    vlSelf->__PVT__io_RD2 = ((((IData)(vlSelf->__PVT__io_WE3) 
                               & ((IData)(vlSelf->__PVT__io_A2) 
                                  == (IData)(vlSelf->__PVT__io_A3))) 
                              & (IData)(vlSelf->__PVT___io_RD1_T_3))
