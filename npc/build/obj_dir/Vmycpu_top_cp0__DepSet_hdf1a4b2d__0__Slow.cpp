...
VL_ATTR_COLD void Vmycpu_top_cp0___eval_initial__TOP__mycpu_top__u_riscv_cpu___cp0(Vmycpu_top_cp0* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_cp0___eval_initial__TOP__mycpu_top__u_riscv_cpu___cp0\n"); );
}

VL_ATTR_COLD void Vmycpu_top_cp0___stl_sequent__TOP__mycpu_top__u_riscv_cpu___cp0__0(Vmycpu_top_cp0* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_cp0___stl_sequent__TOP__mycpu_top__u_riscv_cpu___cp0__0\n"); );
    // Body
...
VL_ATTR_COLD void Vmycpu_top_cp0___stl_sequent__TOP__mycpu_top__u_riscv_cpu___cp0__1(Vmycpu_top_cp0* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_cp0___stl_sequent__TOP__mycpu_top__u_riscv_cpu___cp0__1\n"); );
    // Body
