...
VL_INLINE_OPT void Vmycpu_top_bru_detail___sequent__TOP__mycpu_top__u_riscv_cpu__mem_bru_state__5(Vmycpu_top_bru_detail* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_bru_detail___sequent__TOP__mycpu_top__u_riscv_cpu__mem_bru_state__5\n"); );
    // Body
    vlSelf->__PVT__bht_value = vlSelf->__Vdly__bht_value;
    vlSelf->__PVT__pht_value = vlSelf->__Vdly__pht_value;
}

VL_INLINE_OPT void Vmycpu_top_bru_detail___sequent__TOP__mycpu_top__u_riscv_cpu__mem_bru_state__6(Vmycpu_top_bru_detail* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmycpu_top_bru_detail___sequent__TOP__mycpu_top__u_riscv_cpu__mem_bru_state__6\n"); );
    // Body
    vlSelf->__PVT__io_out_pht = vlSelf->__PVT__pht_value;
    vlSelf->__PVT__io_out_bht = vlSelf->__PVT__bht_value;
}
