...
VL_INLINE_OPT void Vmycpu_top_data_ram_simple_two_ports___combo__TOP__mycpu_top__u_riscv_cpu__branch_prediction_with_blockram__PHTS_banks_oneissue_block_ram__PHTS_with_block_ram__pht_data_with_block_ram__btb_data_ram_0__1(Vmycpu_top_data_ram_simple_two_ports* vlSelf) {
    ...
    vlSymsp->TOP__mycpu_top__inst_cache__icache_tag.__PVT___GEN_294 
        = ((0x26U == (0x7fU & VL_SEL_IQII(64, vlSymsp->TOP__mycpu_top__inst_cache__icache_tag.__PVT__io_addr, 5U, 7U)))
            ? (IData)(vlSymsp->TOP__mycpu_top__inst_cache__icache_tag.__PVT__tag_asid_regs_38)
            : (IData)(vlSymsp->TOP__mycpu_top__inst_cache__icache_tag.__PVT___GEN_293));
