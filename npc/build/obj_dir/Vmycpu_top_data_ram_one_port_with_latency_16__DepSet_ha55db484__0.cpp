...
VL_INLINE_OPT void Vmycpu_top_data_ram_one_port_with_latency_16___nba_sequent__TOP__mycpu_top__data_cache__dcache_data_7__dcache_data_ram_0__6(Vmycpu_top_data_ram_one_port_with_latency_16* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmycpu_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vmycpu_top_data_ram_one_port_with_latency_16___nba_sequent__TOP__mycpu_top__data_cache__dcache_data_7__dcache_data_ram_0__6\n"); );
    // Body
