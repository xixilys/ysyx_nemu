...
--*/
{
   ...
   if (lpRect != NULL)
   {
      ...
      // SDL_UpdateRect(gpScreen, dstrect.x, dstrect.y, dstrect.w, dstrect.h);
   ...
   // printf("")
   // if(dstrect.w  == 106) {
   //    SDL_UpdateRect(gpScreenReal, 0, 0,0,0);
   // }else {
...
--*/
{
   // printf("read w and h is %d %d\n",gpScreenReal->w,gpScreenReal->h);
